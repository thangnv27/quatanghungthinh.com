...
add_action( 'wp_enqueue_scripts', '_ken_Enqueue',999 );
function _ken_Enqueue() {
	wp_enqueue_style(  'ken-zoom-style', get_template_directory_uri(). '/magiczoomplus.css');
	wp_enqueue_script( 'ken-zoom',get_template_directory_uri().'/magiczoomplus.min.js', array( 'jquery' ), '20161220', true );
}