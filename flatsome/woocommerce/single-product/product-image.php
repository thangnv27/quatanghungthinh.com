...
<div class="product-images images relative has-hover">
		...
		<?php
			if ( has_post_thumbnail() ) {
				...
				echo apply_filters( 'woocommerce_single_product_image_html', sprintf( '<div class="slide first"><a id="Zoomer" rel="disable-zoom :false;selectors-class: active;" href="%s" itemprop="image" class="MagicZoomPlus" title="%s" data-rel="prettyPhoto' . $gallery . '">%s</a></div>', $image_link, $image_caption, $image ), $post->ID );
